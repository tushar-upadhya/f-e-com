  ...
  return (
    <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
      <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
        <h2 className="max-w-lg mb-6 font-sans text-3xl font-primary text-accent font-semibold leading-none tracking-tight  sm:text-4xl md:mx-auto">
        ...
        <p className="text-base text-primary font-secondary font-semibold md:text-lg">
      ...
      <div className="grid gap-5 mb-8 md:grid-cols-2 lg:grid-cols-3">
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold leading-5 font-primary text-accent">
            GYM
          </h6>
        ...
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold leading-5 text-accent font-primary">
            Pool
          </h6>
          <p className="text-sm text-gray-900 font-secondary">
        ...
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold text-accent font-primary leading-5">
            Pick Up & Drop
          </h6>
          <p className="text-sm text-gray-900 font-secondary">
        ...
        <div className="p-5 duration-300 transform bg-white border rounded shadow-sm hover:-translate-y-2">
          ...
          <h6 className="mb-2 font-semibold font-primary text-accent leading-5">
            24 * 7
          </h6>
          <p className="text-sm text-gray-900 font-secondary">
